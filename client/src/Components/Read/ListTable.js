                        ...
                        <div className="card list-card">
                            ...
                            <div className="card-body">
                                <table className="table">
                                    <thead>
                                    <tr>
                                        <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Course Name</th>
                                        <th className="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Course Price</th>
                                                    ...
                                                    <td>
                                                        <div className="d-flex  animated fadeInUp px-2 py-1">
                                                            ...
                                                            <div className="d-flex flex-column justify-content-center">
                                                                <h6 className="mb-0 text-sm">{item.courseName}</h6>
                                                                <p className="text-xs text-secondary mb-0">{item.courseCode}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <h6 className="mb-0 animated fadeInUp text-sm"> {item.coursePrice}</h6>
                                                    </td>
                                                    <td>
